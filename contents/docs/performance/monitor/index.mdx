...
![Performance Monitor with a live test running, showing KPI cards, charts, and the Stop Test button](/performance/performance-monitor-live.png)
...
![Percentiles chart view showing P50, P90, P95, and P99 lines diverging under load](/performance/performance-percentiles.png)
