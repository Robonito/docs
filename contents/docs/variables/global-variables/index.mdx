...
![Environment Variables page showing the environment selector and variable list](/assets/environment-manager/empty-environment.png)
...
![Navigation path to Environment Variables in the sidebar](/assets/environment-manager/nav-highlight.png)
...
![Add Variable form with Key, Value, and Type fields](/assets/environment-manager/add-variable.png)
...
![Execution Configuration dialog showing the Environment dropdown](/variables/variables-execution-config-env.png)
...
![Environment Variable step editor for updating a global variable mid-test](/variables/variables-env-step-editor.png)
