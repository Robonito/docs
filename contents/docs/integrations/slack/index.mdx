...
![Slack integration configuration panel showing the Webhook URL field and Save button](/integrations/slack/slack-webhook.png)
...
![Example Slack message from Robonito showing a test run summary with pass/fail counts and a report link](/integrations/slack/slack-message.png)
