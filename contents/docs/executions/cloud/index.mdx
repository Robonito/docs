...
![Suite execution dialog with Cloud selected showing parallel dispatch to multiple workers](/executions/execution-cloud-parallel.png)
...
![Cloud configuration panel showing browser dropdown, screen size, and toggle options](/executions/execution-cloud-config.png)
