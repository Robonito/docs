...
3.  **Enter Connection Details:** A side drawer with a form will open. You'll need to enter this info:
...
## Recording a web test case with Authenticator App OTPs

> **Note:** You should add the respective account first.
Once you have added an account, you can easily generate and fetch OTPs directly during your test case execution.
