...
> **Screenshot placeholder:** *[Screenshot of an API test case with three chained steps: POST /auth/login → GET /users/`{{userId}}` → DELETE /users/`{{userId}}`, each linked by variable arrows]*
...
> **Screenshot placeholder:** *[Screenshot of the Variable Extraction editor with a JSONPath expression and variable name configured]*
...
> **Screenshot placeholder:** *[Screenshot of the API import dialog showing Postman and Swagger/OpenAPI options]*
