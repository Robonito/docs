...
> **Screenshot placeholder:** *[Screenshot of the execution trend graph showing a time-series chart with pass/fail bars, filtered by week]*
...
> **Screenshot placeholder:** *[Screenshot of the execution detail view showing a failed step highlighted in red with a failure screenshot and error message]*
...
> **Screenshot placeholder:** *[Screenshot of the "Log Issue" button on a failed step, with the Jira/Linear/Asana picker]*
...
> **Screenshot placeholder:** *[Screenshot of the API execution report showing request/response panels and assertion results for a chained API test]*
