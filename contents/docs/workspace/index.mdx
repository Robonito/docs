...
description: Learn how to manage projects and isolate automation environments using Robonito Workspaces.
---
...
- **Isolated Resources:** Variables, data sources, and scripts created within this workspace cannot leak into or be executed by other workspaces.
- **Team Access Control:** You can invite individual team members exclusively to this specific workspace workspace.
- **Custom Integrations:** You can bind Slack channels or Jira projects uniquely to this specific workspace.
