...
description: 'Learn how to set up Email (IMAP) integration and automate OTP retrieval for your test cases.'
---
## Understanding Email (IMAP) Integration
...
## Setting Up Email (IMAP) Integration
...
5.  **Confirm Integration:** Back in Robonito, the Email integration status will automatically show as `Connected` for your workspace.
...
4.  **Select "Email" in the Modal:** A modal window will appear. From the available options, select "Email" as your OTP source.
