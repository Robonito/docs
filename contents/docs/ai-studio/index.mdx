...
![AI Studio main interface showing the chat panel, browser mirror, and platform selector](/ai-studio/ai-studio-overview.png)
...
![Sidebar with the AI Studio icon highlighted](/ai-studio/ai-studio-sidebar-icon.png)
...
![Model selector dropdown showing all available AI providers](/ai-studio/ai-studio-model-selector.png)
...
![Browser mirror panel showing the live agent session](/ai-studio/ai-studio-browser-mirror.png)
...
![Plan Mode approval card showing the strategic plan before execution](/ai-studio/ai-studio-plan-mode.png)
...
![Explore Mode Site Map tab showing a visual graph of discovered pages](/ai-studio/ai-studio-explore-sitemap.png)
...
![Slash-command menu in the chat input showing /figma, /github, /jira, /linear, /asana options](/ai-studio/ai-studio-slash-commands.png)
...
![Human-in-the-loop takeover card with Take Over and Resume buttons](/ai-studio/ai-studio-hitl.png)
...
![Generated test case card with Save to Suite button and suite selector dropdown](/ai-studio/ai-studio-save-test.png)
...
![History drawer showing a list of past AI Studio threads](/ai-studio/ai-studio-history.png)
...
![Bug classification pill showing type, severity, and Log Issue button](/ai-studio/ai-studio-bug-pill.png)
