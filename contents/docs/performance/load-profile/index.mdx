...
> **Screenshot placeholder:** *[Screenshot of Fixed Load configuration with virtual users set to 100 and duration set to 10 minutes]*
...
> **Screenshot placeholder:** *[Screenshot of the Load Profile Editor showing a Ramp Up curve from 0 to 200 users over 15 minutes]*
...
> **Screenshot placeholder:** *[Screenshot of the Load Profile Editor with a Ramp Up curve, showing drag handles, phase badges, and snap-to-grid controls]*
