...
![Test case timeline showing a Reuse Test step with the referenced test case name](/reusable-test-cases/reuse-timeline.png)
...
![Reuse Test step editor showing the test case search dropdown](/reusable-test-cases/reuse-step-editor.png)
...
![Recording configuration dialog with the Auth Test Case dropdown highlighted](/reusable-test-cases/reuse-auth-dropdown.png)
