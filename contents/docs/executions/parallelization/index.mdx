...
![Bulk execution configuration dialog showing multiple test cases queued for parallel cloud execution](/executions/execution-parallel-bulk.png)
...
![Suite-level Execute button and cloud execution selection in the Execution Configuration dialog](/executions/execution-parallel-suite.png)
...
![Reports dashboard showing multiple test results sharing the same execution batch ID](/executions/execution-parallel-reports.png)
